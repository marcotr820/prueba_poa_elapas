        ...
        <form action="" method="POST" id="form">  
          ...
          <div class="modal-body">
            <div class="form-group">
              <label for="" class="col-form-label"><b>Nombre Actividad <span class="text-danger">*</span></b></label>
              <input type="text" id="nombre_actividad" name="nombre_actividad" data-error="input" class="form-control" autocomplete="off">
